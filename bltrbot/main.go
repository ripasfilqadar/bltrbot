...
func InitDB() {
	db.MysqlDB().AutoMigrate(&model.User{}, &model.Report{}, &model.Iqob{}, &model.Group{}, &model.Message{}, &model.PrayerTime{}, &model.Feature{}, &model.PrivateUser{}, &model.UserFeature{}, &model.City{})
